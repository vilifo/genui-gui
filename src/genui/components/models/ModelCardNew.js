        ...
        algorithm ? (
            <React.Fragment>
                ...
                <ModelFormRenderer
                    ...
                    component={props => <ModelFormCardBody {...props}
                                                           form={props.form ? props.form : FormikModelForm}/>}
            ...
            <React.Fragment>
                ...
                <CardBody>
                    <UncontrolledDropdown>
                        ...
                        <DropdownMenu>
                            {
                                props.algorithmChoices.map(item => <DropdownItem key={item.id}
                                                                                 onClick={() => setAlgorithm(item)}>{item.name}</DropdownItem>)
                            }
                        </DropdownMenu>
                    </UncontrolledDropdown>
                </CardBody>
